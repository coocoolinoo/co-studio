...
function RotatingBadge({ label }: { label: string }) {
  return (
    <div className="badge-rotate hidden h-20 w-20 lg:block lg:h-24 lg:w-24">
      <svg viewBox="0 0 100 100" className="h-full w-full">
        <defs>
          <path id="hero-badge-circle" d="M 50,50 m -35,0 a 35,35 0 1,1 70,0 a 35,35 0 1,1 -70,0" />
        </defs>
        <text className="fill-near-black font-mono text-[8.5px] tracking-[0.35em] uppercase">
...
export default function Hero() {
  ...
  const badge = useScrambledString(t('hero.badge'), 280)
  ...
  return (
    <section className="relative flex min-h-screen flex-col overflow-hidden">
      ...
      <div className="relative z-10 flex flex-1 flex-col px-5 pt-28 md:px-8">
        <div className="mx-auto flex w-full max-w-[1400px] flex-1 flex-col justify-center pb-8">
          <motion.p
        ...
        <div className="mx-auto flex w-full max-w-[1400px] justify-end pb-4">
          <RotatingBadge label={badge} />
        </div>
      </div>
